  ...
  public: {
    Tables: {
      ...
      disease_treatments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "disease_treatments_treatment_id_fkey"
      ...
      farm_invitations: {
        ...
        Relationships: [
          {
            foreignKeyName: "farm_invitations_accepted_by_fkey"
            columns: ["accepted_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "farm_invitations_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Enums: {
      ...
      event_type:
        ...
        | "slaughter"
        | "note"
      farm_role: "owner" | "admin" | "operator" | "vet" | "viewer" | "regulator"
