...
import { ShieldCheck, ShieldAlert, ShieldX, ExternalLink, Hash, Clock } from "lucide-react";
...
export default async function VerifyPage({
  ...
  const StatusIcon = data.integrity_ok ? ShieldCheck : hasAnchors ? ShieldAlert : ShieldX;
  ...
  const statusText = data.integrity_ok
    ...
    : hasAnchors
      ? "Registro modificado"
      : "Sin anclar en blockchain";

  const statusDesc = data.integrity_ok
    ? "El registro no ha sido alterado desde que fue anclado en blockchain."
    : hasAnchors
      ? "El registro tiene un ancla en blockchain pero su hash ya no coincide: pudo haber sido modificado."
      : "Este registro aún no tiene anclaje en blockchain.";
  ...
  return (
    <main className="min-h-screen bg-neutral-950 p-4 text-white md:p-8">
      <div className="mx-auto max-w-xl space-y-4">
        ...
        {/* Anclas blockchain — la prueba de este registro. En esta app no hay
            firmas de wallet; la integridad se respalda con el/los anclajes. */}
